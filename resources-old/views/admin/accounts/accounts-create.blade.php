                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-section bg-white">
                                <h4 class="ml-0 f-21 font-weight-normal text-capitalize"style="color: var(--own-black)">
                                    Create Accounting Report</h4>
                                <hr class="border-top-grey">
                                <form action="{{ route('accountreport/create') }}" method="post">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-g  roup">
                                                <label> Cheque No./Reciept
                                                    No.</span></label>
                                                <input type="text" class="form-control"
                                                    name="cheque_number_receipt_number"
                                                    value="{{ old('cheque_number_receipt_number') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="Column_1" name="column_1">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Column 2</label>
                                                <input class="form-control" type="text" id="Column_2" name="column_2">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
