...
@section('content')
    <div class="all-content-wrapper" >
        <div class="header-advance-area" style="background: #fff">
            ...
            <div class="static-table-area mg-t-15" id="englishContent"
                style="{{ !session('locale') || session('locale') === 'en' ? '' : 'display: none;' }}">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <article>
                                ...
                                <div class="norm">
                                    <p> <b style="background: #1B2A47; color:#fff; padding: 5px">PAYMENT TERMS</b> <br>
                                ...
                                <div class="norm">
                                    <p> <b style="background: #1B2A47; color:#fff; padding: 5px">GENERAL NOTES</b> <br>
                                    <p><b>1 .</b> 30% AG Advanced Payments CONTRACTING</p>
                                    <p> <b>2 .</b> 30% AG Advanced Payments CONTRACTING</p>
                                    <p> <b>3 .</b> 30% AG Advanced Payments CONTRACTING</p>
                                </div><br>
                                <div class="norm">
                                    <p> <b style="background: #1B2A47; color:#fff; padding: 5px">DURATION</b> <br>
                                    <p><b>1 .</b> 30% AG Advanced Payments CONTRACTING</p>
                                </div>
                            </article>
                            <address style="float: right; color:#000">
                                ...
                                <p> <b>NAME :</b> ................. <br>
                                <p> <b>DATE # :</b> ................ <br>
                                <p> <b style="background: #1B2A47; color:#fff; padding: 5px">CUSTOMER ACCEPTANCE</b> <br>
                            </address>
                            <address style="color: #000">
                                <p><b>SIGNATURE :</b> ..................</p>
                                <p> <b>NAME :</b> ................. <br>
                                <p> <b>DATE # :</b> ................ <br>
                                <p> <b style="background: #1B2A47; color:#fff; padding: 5px">AG GENERAL TRAD. & CONT. CO.
                                        :</b> <br>
                            </address>
                        </div>
                    </div>
            ...
            <div class="static-table-area mg-t-15" id="arabicContent"
                style="{{ session()->get('locale') == 'ar' ? '' : 'display: none;' }}">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <article>
                                ...
                                <table class="meta-arabic">
                                    <tr>
                                        <td><span
                                                data-prefix>$</span><span>{{ GoogleTranslate::trans('600.00', app()->getLocale()) }}</span>
                                        </td>
                                ...
                                <div class="norm-arabic">
                                    <p> <b
                                            style="background: #1B2A47; color:#fff; padding: 5px">{{ GoogleTranslate::trans('PAYMENT TERMS', app()->getLocale()) }}</b>
                                        <br>
                                ...
                                <div class="norm-arabic">
                                    <p> <b
                                            style="background: #1B2A47; color:#fff; padding: 5px">{{ GoogleTranslate::trans('GENERAL NOTES', app()->getLocale()) }}</b>
                                        <br>
                                    <p> {{ GoogleTranslate::trans('Advanced Payments CONTRACTING', app()->getLocale()) }}<b>.
                                            1 </b></p>
                                    <p> {{ GoogleTranslate::trans('Advanced Payments CONTRACTING', app()->getLocale()) }}<b>.
                                ...
                                <div class="norm-arabic">
                                    <p> <b
                                            style="background: #1B2A47; color:#fff; padding: 5px">{{ GoogleTranslate::trans('DURATION', app()->getLocale()) }}</b>
                                        <br>
                                    <p> {{ GoogleTranslate::trans('Advanced Payments CONTRACTING', app()->getLocale()) }}<b>
                                            . 1 </b></p>
                                </div>
                            ...
                            <address class="norm-arabic" style="float: right; color:#000">
                                ...
                                <p> ................ <b> : {{ GoogleTranslate::trans('DATE', app()->getLocale()) }}</b>
                                    <br>
                                <p> <b
                                        style="background: #1B2A47; color:#fff; padding: 5px">{{ GoogleTranslate::trans('CUSTOMER ACCEPTANCE', app()->getLocale()) }}</b>
                                    <br>
                            </address>
                            <address style="color: #000">
                                <p> .................. <b>:
                                ...
                                <p> ................ <b> : {{ GoogleTranslate::trans('DATE', app()->getLocale()) }}</b>
                                    <br>
                                <p> <b style="background: #1B2A47; color:#fff; padding: 5px">
