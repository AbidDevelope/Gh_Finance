<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('assets/admin/fonts/nalika.ttf') }}"> --}}
    {{-- <link rel="stylesheet" href="{{ asset('assets/admin/fonts/nalika.woff') }}"> --}}
    ...
    <link href="{{ asset('assets/admin/css/filter.css') }}" rel="stylesheet">
