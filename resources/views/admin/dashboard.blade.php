        ...
        <div class="row   mx-1 gap-1 flex-nowrap">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 p-3 shadow" style="background-color: white">
                <div class="row align-items-center">
                    ...
                    <div class="col-8">
                        <p class="m-0 dashboard-color-text">New Leads</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 p-3 shadow" style="background-color: white">
                <div class="row align-items-center">
                    ...
                    <div class="col-8">
                        <p class="m-0 dashboard-color-text">Services</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 p-3 shadow" style="background-color: white">
                <div class="row align-items-center">
                    ...
                    <div class="col-8">
                        <p class="m-0 dashboard-color-text">Order</p>
...
let piechart =
    '[{"name":"Access From","type":"pie","radius":"50%","data":[{"value":1048,"name":"Search Engine"},{"value":484,"name":"Constructions"},{"value":300,"name":"Design & Constructions"}],"emphasis":{"itemStyle":{"shadowBlur":10,"shadowOffsetX":0,"shadowColor":"rgba(0, 0, 0, 0.5)"}}}]';
