                ...
                <div class="container-fluid">
                    <div class="row margin_top mx-2">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_bottom">
                            <div class="pb">
                                <h4 class=" text-headings">Invoices</h4>
                            </div>
                            <div class=" text-right">
                                <div class="table-actions">
                                    <a href="{{ route('invoices/create') }}"
                                        class="btn bg_button text-white rounded f-1 p- mr-3 float-left mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <div class="d-flex">
                                        <div class=" ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="start_date" name="start_date" placeholder="Select Start Date" class="form-control placeholder  rounded text-black-50"
                                        ...
                                        <div class="container  d-flex gap-4 ">
                                            <div class=" form-group">
                                                ...
                                                <input type="text" id="end_date" class="form-control placeholder  text-black-50 rounded"
