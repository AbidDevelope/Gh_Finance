                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-section bg-white">
                                <h4 class="ml-0 f-21 font-weight-normal text-capitalize"style="color: var(--own-black)">
                                    Create Indemnity & Leave</h4>
                                <hr class="border-top-grey">
                                <form action="{{ route('indemnity/create') }}" method="post">
                                    @csrf
                                    @if ($errors->any())
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input readonly class="form-control" type="text" name="service_type"
                                                    id="project_type" value="{{ old('service_type') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-g  roup">
                                                ...
                                                <input type="text" class="form-control"
                                                    name="cheque_number_receipt_number" value="{{ old('cheque_number_receipt_number') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="amount_deposited"
                                                    name="amount_deposited" value="{{ old('amount_deposited') }}" onkeypress="return /[0-9]/i.test(event.key)">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="amount_withdrawn"
                                                    name="amount_withdrawn" value="{{ old('amount_withdrawn') }}" onkeypress="return /[0-9]/i.test(event.key)">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
