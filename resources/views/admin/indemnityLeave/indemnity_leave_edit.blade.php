                    ...
                    <div class="margin_top mx-3">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-section bg-white">
                                <h4 class="ml-0 f-21 font-weight-normal text-capitalize"style="color: var(--own-black)">Edit Indemnity & Leave</h4>
                                <hr class="border-top-grey">
                                <form action="{{ route('indemnity&leave/update', $indemnity->id) }}" method="post">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                name="date" value="{{ \Carbon\Carbon::parse($indemnity->date)->format('d/m/Y') }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="project_id" id="project_id" value="{{ $indemnity->project_id }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Project Type</label>
                                                <input readonly class="form-control" type="text" name="service_type" id="project_type" value="{{ $indemnity->service_type }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Project Name</label>
                                                <input readonly class="form-control" type="text" name="project_name" id="project_name" value="{{ $indemnity->project_name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                name="beneficiary" value="{{ $indemnity->beneficiary }}"
                                                placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-g  roup">
                                                ...
                                                <input type="text" class="form-control"  name="cheque_number_receipt_number" value="{{ $indemnity->cheque_number_receipt_number }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="amount_deposited" value="{{ $indemnity->amount_deposited }}"
                                                name="amount_deposited" onkeypress="return /[0-9]/i.test(event.key)">                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Amount Withdrawn</label>
                                                <input class="form-control" type="text" id="amount_withdrawn" value="{{ $indemnity->amount_withdrawn }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                style="min-width:120px" name="remarks"
                                                value="{{ $indemnity->remarks }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Description</label>
                                                <textarea name="description" class="form-control" type="text">{{ $indemnity->description }}</textarea>
                                            </div>
                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                ...
                                                                <input readonly class="form-control text-right"
                                                                    ...
                                                                    value="{{ $indemnity->total_in_account }}">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
