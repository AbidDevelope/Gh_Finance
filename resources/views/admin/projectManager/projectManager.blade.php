            ...
            <div class="breadcome-area">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="mt-3 text-headings">Project Manager</h4>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <tbody>
                                    @if (count($projectManagers) > 0)
                                        @foreach ($projectManagers as $key=>$projectManager)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>{{ $projectManager->created_at->format('d M Y') }}</td>
                                                <td>{{ $projectManager->name }}</td>
                                                <td class="text-center">
                                                    <div class="dropdown action-label">
                                                        <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                            @if($projectManager->status == 'Active')
                                                            <i class="fa fa-dot-circle-o text-success"></i> {{ $projectManager->status }}
                                                            @else
                                                            <i class="fa fa-dot-circle-o text-danger"></i> {{ $projectManager->status }}
                                                            @endif
                                                        </a>
