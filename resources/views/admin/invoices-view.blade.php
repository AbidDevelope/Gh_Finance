                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <address class="norm">
                                <p> <b style="background: var(--filter-color); color:#fff; padding: 5px">BENEFICIARY'S BANK DETAILS</b> <br>
                        ...
                        <address style="float: right; color:#000">
                            ...
                            <p> <b>NAME :</b> ................. <br>
                            <p> <b>DATE # :</b> ................ <br>
                            <p> <b style="background: var(--filter-color); color:#fff; padding: 5px">AG GENERAL TRAD. & CONT. CO. :</b> <br>
                        </address>
                    </div>
                </div>
            </div>
