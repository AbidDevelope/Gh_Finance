                                    ...
                                    <div class=" ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_date" id="start_date"
                                                ...
                                                class="form-control cursor bg-white placeholder rounded text-black-50"
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" {{-- href="{{ route('expenses/view', $item->id) }}"><i --}}
                                                        href="{{ route('others/view') }}"><i class="fa fa-eye m-r-5"></i>
                                                        View</a>
                                                    <a class="dropdown-item" href="{{ route('others/edit') }}"><i
